...
module API
  class GitKernelOrg
    ...
    # repo_url: https://git.kernel.org/cgit/linux/kernel/git/kdave/btrfs-progs.git
    ...
    # URL. https://git.kernel.org/cgit/linux/kernel/git/kdave/btrfs-progs.git/commit/
    def last_commits
      last_commit = nil
...
if __FILE__ == $0
  url = 'https://git.kernel.org/cgit/linux/kernel/git/kdave/btrfs-progs.git'
